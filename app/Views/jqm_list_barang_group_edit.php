...
<body>
    <div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-responsive-page1" data-title="Panel responsive page">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <form action="<?= base_url('/edit_barang_group/' . $barang_group['id']) ?>" method="post">
                <label for="name">Nama Group:</label>
                <input type="text" name="name" id="name" value="<?= $barang_group['name'] ?>" required>
                <input type="hidden" name="id" value="<?= $barang_group['id'] ?>">
            ...
            <a href="<?= base_url('/delete_barang_group/' . $barang_group['id']) ?>" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-btn-b ui-mini ui-icon-delete ui-btn-icon-left">Delete Group</a>
